...
| next | **R5 — candidates:** gNMI/NETCONF network device monitoring (OQ-16 remainder), SM→agent directed-action transport (unblocks firmware campaigns + marketplace push in production), multi-replica audit-chain advisory locking, trained predictive models |
