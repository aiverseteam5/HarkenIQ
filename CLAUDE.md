...
| next | **R6 wrap**: OQ-16 close-out in spec §8; then trained predictive models once outcome data accumulates, or vendor NOS breadth (Arista/Cisco) / server NIC collection (TODOS N1) |
